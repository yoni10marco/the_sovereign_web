...
export function CTABanner({ headline, description, button_text }: CTABannerProps) {
  return (
    ...
    >
      ...
      <p className="mt-4 text-base sm:text-lg opacity-80 max-w-2xl mx-auto">{description}</p>
      <button
        className="mt-8 px-6 sm:px-8 py-3 font-semibold transition-transform hover:scale-105"
        style={{
